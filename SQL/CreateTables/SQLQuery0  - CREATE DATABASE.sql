...
(
	...
	direction		TINYINT			NOT NULL		CONSTRAINT FK_GropsDirecrion FOREIGN KEY REFERENCES Directions(direction_id)
);
...
(
	...
	--GETDATE() - Возвращает текущую дату и время в  фармате DATETIME
